...
{
    public class DownloadTask_Data : IHmsBaseClass{
        public string name => "com.huawei.agconnect.cloud.storage.core.DownloadTask";
    }
    public class DownloadTask :HmsClass<DownloadTask_Data>
    {
        public DownloadTask (): base() { }
        ...
        public class DownloadResult_Data : IHmsBaseClass{
            public string name => "com.huawei.agconnect.cloud.storage.core.DownloadTask$DownloadResult";
        }
        public class DownloadResult :HmsClass<DownloadResult_Data>
        {
            public DownloadResult (): base() { }
