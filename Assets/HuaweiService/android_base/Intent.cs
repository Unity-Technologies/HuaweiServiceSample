...
{
    public class Intent_Data : IHmsBaseClass{
        public string name => "android.content.Intent";
    }
    public class Intent :HmsClass<Intent_Data>
    {
        ...
        public Intent setData(Uri arg0) {
            return Call<Intent>("setData", arg0);
        }
    }
}